...
export function WorkspacePage() {
  ...
  const { width, onMouseDown, onMouseUp, onMouseMove } = useResizableWidth(380, 300, 560);
  ...
  return (
    <div className="flex h-[calc(100vh-104px)] flex-col">
      ...
      <Card padding="none" className="flex min-h-0 flex-1 overflow-hidden">
        ...
        <div className="flex min-w-0 flex-1" onMouseMove={onMouseMove} onMouseUp={onMouseUp}>
              ...
              {activeTab === 'pipeline' && (
                <div className="flex flex-col gap-4">
                  ...
                  <p className="text-xs text-[var(--color-text-secondary)]">
                    Semantic Report, TAC, Optimization Comparison, and Assembly Viewer arrive
                    across Sprints 6–7, per Phases.md. Tokens, Symbol Table, and Parse Tree are
                    live now -- check the tabs above.
                  </p>
                </div>
              )}
